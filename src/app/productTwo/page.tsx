...
const SecThree2 = () => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const data = await client.fetch(
          `*[_type=="products"] | order(_createdAt desc)[9..12]{
            _id,
            name,
            description,
            price,
  ...
  <Link href={`/productTwo/${product._id}`}>
    <button className="bg-[#b42fb8] text-black px-6 py-2 font-semibold hover:bg-[#892aa6] transition-colors duration-300">
      View Detail
    </button>
  </Link>
